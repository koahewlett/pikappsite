      ...
      <div className="countdown-shell relative overflow-hidden rounded-[2rem] border border-white/10 bg-black/40 p-5 shadow-[0_40px_90px_-40px_rgba(0,0,0,0.85)] backdrop-blur-xl">
        ...
        <div className="relative flex flex-col items-center gap-4 text-center">
          ...
          <div className="countdown-screen flex flex-nowrap items-center justify-center gap-3 rounded-[1.75rem] bg-[#060606]/90 px-5 py-4 shadow-inner shadow-black/50 ring-1 ring-white/10 sm:px-6">
            <span className="text-4xl font-black tracking-[0.22em] text-gold drop-shadow-[0_0_24px_rgba(212,175,55,0.22)] font-mono tabular-nums sm:text-5xl">
              {hoursLabel}
            </span>
            <span className="blink-colon text-4xl font-black tracking-[0.22em] text-gold/80 drop-shadow-[0_0_18px_rgba(212,175,55,0.14)] font-mono sm:text-5xl">
              :
            </span>
            <span className="text-4xl font-black tracking-[0.22em] text-gold drop-shadow-[0_0_24px_rgba(212,175,55,0.22)] font-mono tabular-nums sm:text-5xl">
              {minsLabel}
            ...
            <span
              key={secsLabel}
              className="countdown-second text-4xl font-black tracking-[0.22em] text-gold drop-shadow-[0_0_26px_rgba(212,175,55,0.24)] font-mono tabular-nums sm:text-5xl"
            >
              {secsLabel}
            </span>
          </div>
