    ...
    <main className="relative min-h-screen overflow-hidden bg-ink bg-rose-grid rose">
      ...
      <section className="relative isolate flex min-h-screen items-center overflow-hidden px-6 pt-24">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          <p className="mb-4 text-sm font-bold uppercase tracking-[.4em] text-gold">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <a href="#apply" className="rounded-full bg-gold px-7 py-4 font-black text-ink">
              Apply for Rush
            </a>
            <a href="#why" className="rounded-full border border-white/15 px-7 py-4 font-bold">
              Learn More
            </a>
          </div>
          <div className="mt-8">
      ...
      <section id="gallery" className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="masonry mt-8">
          {gallery.map((g) => (
            <div
              key={g}
              className="glass group h-56 overflow-hidden rounded-[2rem] p-6 transition hover:scale-[1.02] md:h-72"
            >
